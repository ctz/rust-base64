...
pub const STANDARD_ENCODE: &'static [char; 64] = &[
    'A', // input 0 (0x0) => 'A' (0x41)
    'B', // input 1 (0x1) => 'B' (0x42)
    'C', // input 2 (0x2) => 'C' (0x43)
    'D', // input 3 (0x3) => 'D' (0x44)
    'E', // input 4 (0x4) => 'E' (0x45)
    'F', // input 5 (0x5) => 'F' (0x46)
    'G', // input 6 (0x6) => 'G' (0x47)
    'H', // input 7 (0x7) => 'H' (0x48)
    'I', // input 8 (0x8) => 'I' (0x49)
    'J', // input 9 (0x9) => 'J' (0x4A)
    'K', // input 10 (0xA) => 'K' (0x4B)
    'L', // input 11 (0xB) => 'L' (0x4C)
    'M', // input 12 (0xC) => 'M' (0x4D)
    'N', // input 13 (0xD) => 'N' (0x4E)
    'O', // input 14 (0xE) => 'O' (0x4F)
    'P', // input 15 (0xF) => 'P' (0x50)
    'Q', // input 16 (0x10) => 'Q' (0x51)
    'R', // input 17 (0x11) => 'R' (0x52)
    'S', // input 18 (0x12) => 'S' (0x53)
    'T', // input 19 (0x13) => 'T' (0x54)
    'U', // input 20 (0x14) => 'U' (0x55)
    'V', // input 21 (0x15) => 'V' (0x56)
    'W', // input 22 (0x16) => 'W' (0x57)
    'X', // input 23 (0x17) => 'X' (0x58)
    'Y', // input 24 (0x18) => 'Y' (0x59)
    'Z', // input 25 (0x19) => 'Z' (0x5A)
    'a', // input 26 (0x1A) => 'a' (0x61)
    'b', // input 27 (0x1B) => 'b' (0x62)
    'c', // input 28 (0x1C) => 'c' (0x63)
    'd', // input 29 (0x1D) => 'd' (0x64)
    'e', // input 30 (0x1E) => 'e' (0x65)
    'f', // input 31 (0x1F) => 'f' (0x66)
    'g', // input 32 (0x20) => 'g' (0x67)
    'h', // input 33 (0x21) => 'h' (0x68)
    'i', // input 34 (0x22) => 'i' (0x69)
    'j', // input 35 (0x23) => 'j' (0x6A)
    'k', // input 36 (0x24) => 'k' (0x6B)
    'l', // input 37 (0x25) => 'l' (0x6C)
    'm', // input 38 (0x26) => 'm' (0x6D)
    'n', // input 39 (0x27) => 'n' (0x6E)
    'o', // input 40 (0x28) => 'o' (0x6F)
    'p', // input 41 (0x29) => 'p' (0x70)
    'q', // input 42 (0x2A) => 'q' (0x71)
    'r', // input 43 (0x2B) => 'r' (0x72)
    's', // input 44 (0x2C) => 's' (0x73)
    't', // input 45 (0x2D) => 't' (0x74)
    'u', // input 46 (0x2E) => 'u' (0x75)
    'v', // input 47 (0x2F) => 'v' (0x76)
    'w', // input 48 (0x30) => 'w' (0x77)
    'x', // input 49 (0x31) => 'x' (0x78)
    'y', // input 50 (0x32) => 'y' (0x79)
    'z', // input 51 (0x33) => 'z' (0x7A)
    '0', // input 52 (0x34) => '0' (0x30)
    '1', // input 53 (0x35) => '1' (0x31)
    '2', // input 54 (0x36) => '2' (0x32)
    '3', // input 55 (0x37) => '3' (0x33)
    '4', // input 56 (0x38) => '4' (0x34)
    '5', // input 57 (0x39) => '5' (0x35)
    '6', // input 58 (0x3A) => '6' (0x36)
    '7', // input 59 (0x3B) => '7' (0x37)
    '8', // input 60 (0x3C) => '8' (0x38)
    '9', // input 61 (0x3D) => '9' (0x39)
    '+', // input 62 (0x3E) => '+' (0x2B)
    '/', // input 63 (0x3F) => '/' (0x2F)
];
...
pub const URL_SAFE_ENCODE: &'static [char; 64] = &[
    'A', // input 0 (0x0) => 'A' (0x41)
    'B', // input 1 (0x1) => 'B' (0x42)
    'C', // input 2 (0x2) => 'C' (0x43)
    'D', // input 3 (0x3) => 'D' (0x44)
